...
const ProfileCard2 = () => {
  return (
    <div
      className={`
       h-[36rem] w-[20rem]   relative`}
    >
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-transparent to-black/50 to-90%"></div>
      <div className="h-full w-full bg-black bg-[left_-6rem_top_0px] bg-[length:600px_600px] bg-girl2-background-dateapp rounded-[3rem]"></div>
      ...
      <div className="absolute  left-0  bottom-0  w-full px-5 py-3 ">
        ...
        <h1 className="text-3xl  text-white ">Effie Holland, 24</h1>
        <div className="flex gap-1 font-clemente text-white/50 mt-1">
          <MapPin color="white" size={20}></MapPin>
          <p className="font-light">10 kilometers</p>
        </div>
