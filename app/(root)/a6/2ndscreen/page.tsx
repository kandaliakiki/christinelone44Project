  ...
  return (
    <div>
      <div className="h-[90vh]  text-white px-3 ">
        <div className="h-3/4 w-full rounded-[3rem] relative bg-[left_-6rem_top_0px] bg-[length:600px_600px] bg-girl2-background-dateapp  px-5 py-5 mt-5">
            ...
            <div className="z-10 space-y-2">
              <div className="flex items-center text-white gap-1 opacity-50">
                <Image
                  ...
                  className=""
                ></Image>
                <p className="text-sm">France, Toulouse</p>
              </div>
              <div className="flex items-center gap-3 z-20">
                <span className="text-6xl font-inter italic font-semibold ">
                  Trisha
                </span>
                <span className="text-6xl italic ">28</span>
                <Image
                  alt="verified icon"
              ...
              <div className="flex gap-1">
                <div className="rounded-full px-4 py-3 bg-white/20 backdrop-blur-lg flex  justify-center items-center   ">
                  <p className=" text-xs whitespace-nowrap">Surfing</p>
                </div>
                <div className="rounded-full px-4 py-3 bg-white/20  backdrop-blur-lg flex justify-center items-center   ">
                  <p className=" text-xs whitespace-nowrap ">Horror Movies</p>
                </div>
                <div className="rounded-full px-4 py-2 bg-white/20  backdrop-blur-lg flex justify-center items-center   ">
                  <p className=" text-xs  whitespace-nowrap">+25</p>
                </div>
              </div>
            </div>
          </div>
