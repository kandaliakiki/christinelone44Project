...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable}  ${geistMono.variable} ${barlow.variable}  ${modular_amplitude.variable} ${roboto.variable} ${amaranth.variable} ${schibstedGrotesk.variable} ${montserrat.variable} ${outfit.variable} ${lufga.variable} ${suezone.variable} ${sfProDisplay.variable} ${suisseIntl.variable} ${overusedGrotesk.variable} ${clemente.variable} ${geometria.variable} ${neueMachina.variable} ${formaDJRMicro.variable} ${graphie.variable} ${gilroy.variable} ${dmSans.variable} ${nunitoSans.variable}  antialiased flex flex-col min-h-screen`}
      >
        {children}
      </body>
    </html>
