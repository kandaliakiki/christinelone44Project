...
const nunitoSans = localFont({
  src: [
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-Light.ttf",
      weight: "300",
      style: "normal",
    },
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-Regular.ttf",
      weight: "400",
      style: "normal",
    },
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-Medium.ttf",
      weight: "500",
      style: "normal",
    },
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-SemiBold.ttf",
      weight: "600",
      style: "normal",
    },
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-Bold.ttf",
      weight: "700",
      style: "normal",
    },
    {
      path: "../public/fonts/NunitoSans/NunitoSans_10pt-ExtraBold.ttf",
      weight: "800",
      style: "normal",
    },
  ],
...
const mulish = localFont({
  src: [
    ...
    {
      path: "../public/fonts/Mulish/Mulish-Medium.ttf",
      weight: "500",
      style: "normal",
    },
    {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable}  ${geistMono.variable} ${barlow.variable}  ${modular_amplitude.variable} ${roboto.variable} ${amaranth.variable} ${schibstedGrotesk.variable} ${montserrat.variable} ${outfit.variable} ${lufga.variable} ${suezone.variable} ${sfProDisplay.variable} ${suisseIntl.variable} ${overusedGrotesk.variable} ${clemente.variable} ${geometria.variable} ${neueMachina.variable} ${formaDJRMicro.variable} ${graphie.variable} ${gilroy.variable} ${dmSans.variable} ${nunitoSans.variable} ${lato.variable} ${mulish.variable}  antialiased flex flex-col min-h-screen`}
      >
        {children}
      </body>
    </html>
